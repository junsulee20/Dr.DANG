...
[반환할 JSON 스키마]
{
  ...
  "tips": [
    ...
    {
      "type": "보완 음식",
      "content": "전문적인 조언. (가이드: '닭가슴살', '견과류', '채소', '계란' 같은 일반적인 예시에만 의존하지 마세요. 물론 이들도 좋은 음식이지만, 매번 반복해서는 안 됩니다. 또한 특정 음식(예: 낫토, 특정 발효식품 등)을 반복적으로 추천하지 마세요. 대신, 이 음식의 혈당 반응을 늦출 수 있는 **다양하고 구체적인 식재료나 식품군**을 매번 다르게 제안하세요. '왜' 좋은지 **원리**(예: 지방/단백질의 소화 지연, 식이섬유의 역할, 특정 영양소의 상호작용 등)를 설명하되, 음식 예시는 매번 다양하게 선택하세요. 생리학적 원리와 함께 적극적으로, 그리고 창의적으로 제안하세요.)"
    },
    {
      "type": "식사 순서",
      "content": "전문적인 조언. (가이드: '채소/단백질 먼저 드세요'라는 **단순한 순서 나열을 피하세요.** 또한 특정 식재료(예: 식초 등)를 반복적으로 강조하지 마세요. 대신 '왜' 그 순서가 중요한지 **구체적인 '생리학적 원리'**를 한 가지 설명하세요. (예: 위 배출 속도 지연, 특정 호르몬 자극, 소화 효소 활성화, 혈당 조절 메커니즘 등) **매번 다른 원리**를 설명하고, 특정 식재료에 의존하지 말고 원리 자체에 집중하세요. 적극적으로, 그리고 창의적으로 설명하도록 노력하세요.)"
    }
  ]
}`
